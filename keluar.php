...
<html lang="en">
    <head>
        ...
        <title>Barang Keluar | AR Furniture</title>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.php">AR Furniture</a>
            <!-- Sidebar Toggle-->
            <button class="btn btn-link btn-sm order-1 order-lg-0 me-4 me-lg-2 ms-auto" id="sidebarToggle" href="#!"><i class="fas fa-bars me-auto"></i></button>
        </nav>
